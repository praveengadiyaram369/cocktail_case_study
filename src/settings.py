...
SQL_DATA_FILEPATH = os.getcwd() + "/sql_static_data/"

DB_PATH = os.getcwd() + "/sqlite_db/sqlite_cocktail_db.db"

LOG_FILENAME = os.getcwd() + "/logs/cocktail_data_logger.log"
logging.basicConfig(
    handlers=[logging.FileHandler(filename=LOG_FILENAME, encoding="utf-8", mode="a+")],
    level=logging.INFO,
)
...
CREATE_TABLE_COCKTAIL_INGREDIENTS = """CREATE TABLE IF NOT EXISTS cocktail_ingredients (
                                ...
                                ingredient_sequence_id INTEGER NOT NULL,
                                min_quantity REAL NOT NULL,
                                max_quantity REAL NOT NULL,
                                measurement_unit_id INTEGER NOT NULL,
                                meta_data TEXT,
                                PRIMARY KEY (drink_id, ingredients_id, ingredient_sequence_id),
